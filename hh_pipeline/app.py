...
def build_pipeline() -> CSVLoadHandler:
    ...
    (
        ...
        .set_next(AgeSanityHandler())
        .set_next(SalaryHandler())
        .set_next(TargetSanityHandler(target=config.TARGET_COLUMN))
